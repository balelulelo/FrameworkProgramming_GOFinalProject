           ...
           <div className="flex flex-col gap-1 min-h-[60px]">
                ...
                <div className="flex flex-col">
                    {/* <p className="text-[#1DB954] text-xs font-medium">
                        By {cafe.user ? cafe.user.username : 'Unknown'}
                    </p> */}
                    {/* di atas ini buat nampilin "By: User di card cafenya. kalo mau di uncomment aja" */}

                    <p className="text-[#6a6a6a] text-[10px]">
                        {formatDate(cafe.CreatedAt)} {/* upload date */}
                    </p>
                </div>


                <p className="text-[#a7a7a7] text-sm line-clamp-2 leading-tight mt-1">
